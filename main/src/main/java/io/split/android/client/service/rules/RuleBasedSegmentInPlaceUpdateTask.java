...
public class RuleBasedSegmentInPlaceUpdateTask implements SplitTask {
    ...
    public SplitTaskExecutionInfo execute() {
        try {
            ...
            if (triggerSdkUpdate) {
                EventMetadata metadata = createUpdatedSegmentsMetadata();
    ...
    private EventMetadata createUpdatedSegmentsMetadata() {
        return EventMetadataHelpers.createSegmentUpdateMetadata(
                Collections.singletonList(mRuleBasedSegment.getName()), mChangeNumber);
    }
}
