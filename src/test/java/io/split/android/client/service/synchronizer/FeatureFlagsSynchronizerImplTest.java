...
public class FeatureFlagsSynchronizerImplTest {
    ...
    public void loadAndSynchronizeSplits() {
        ...
        when(mTaskFactory.createSplitsSyncTask(true, mTaskFactory.mSplitClientConfig.forceCacheExpiration())).thenReturn(mockSplitSyncTask);
    ...
    public void splitExecutorSchedule() {
        ...
        when(mTaskFactory.createSplitsSyncTask(false, mTaskFactory.mSplitClientConfig.forceCacheExpiration())).thenReturn(mockTask);
    ...
    public void startPeriodicFetchingCancelsPreviousTaskIfExecutedSequentially() {
        ...
        when(mTaskFactory.createSplitsSyncTask(false, mTaskFactory.mSplitClientConfig.forceCacheExpiration()))
                .thenReturn(mockTask)
