...
public class MySegmentsUpdateTaskTest {
    ...
    public void correctExecution() throws HttpFetcherException {
        mTask = new MySegmentsUpdateTask(mySegmentsStorage, false, Collections.singleton(mSegmentToRemove), changeNumber, mEventsManager, mTelemetryRuntimeProducer, MySegmentsUpdateTaskConfig.getForMySegments());
    ...
    public void correctExecutionToEraseNotInSegments() throws HttpFetcherException {
        ...
        mTask = new MySegmentsUpdateTask(mySegmentsStorage, false, Collections.singleton(otherSegment), changeNumber, mEventsManager, mTelemetryRuntimeProducer, MySegmentsUpdateTaskConfig.getForMySegments());
        ArgumentCaptor<List<String>> segmentsCaptor = ArgumentCaptor.forClass(List.class);
    ...
    public void successfulAddOperationIsRecordedInTelemetry() {
        mTask = new MySegmentsUpdateTask(mySegmentsStorage, true, Collections.singleton(mSegmentToRemove), changeNumber, mEventsManager, mTelemetryRuntimeProducer, MySegmentsUpdateTaskConfig.getForMySegments());
    ...
    public void addOperationWithSegmentsAlreadyInStorage() {
        ...
        mTask = new MySegmentsUpdateTask(mySegmentsStorage, true, oldSegments, changeNumber, mEventsManager, mTelemetryRuntimeProducer, MySegmentsUpdateTaskConfig.getForMySegments());
    ...
    public void addOperationWithOneSegmentAlreadyInStorage() {
        ...
        mTask = new MySegmentsUpdateTask(mySegmentsStorage, true, new HashSet<>(Arrays.asList(mCustomerSegment, mSegmentToRemove)), changeNumber, mEventsManager, mTelemetryRuntimeProducer, MySegmentsUpdateTaskConfig.getForMySegments());
    ...
    public void removeOperationRemovesOnlyNotifiedSegments() {
        ...
        mTask = new MySegmentsUpdateTask(mySegmentsStorage, false, new HashSet<>(Arrays.asList(mSegmentToRemove, "extra_segment")), changeNumber, mEventsManager, mTelemetryRuntimeProducer, MySegmentsUpdateTaskConfig.getForMySegments());
    ...
    public void removeOperationDoesNotNotifyWhenNothingWasRemoved() {
        ...
        mTask = new MySegmentsUpdateTask(mySegmentsStorage, false, Collections.singleton("extra_segment"), changeNumber, mEventsManager, mTelemetryRuntimeProducer, MySegmentsUpdateTaskConfig.getForMySegments());
