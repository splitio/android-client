...
public class LocalhostAttributesManagerTest {
    ...
    private LocalhostAttributesManager attributeClient;
    private Map<String, Object> testValues;

    @Before
    public void setUp() {
        MockitoAnnotations.openMocks(this);
        attributeClient = new LocalhostAttributesManager(attributesStorage, attributesValidator, validationMessageLogger);
        testValues = getDefaultValues();
    }

    @Test
    public void setAttributeUpdatesValuesInStorage() {
        String name = "key";
    ...
    @Test
    public void setAttributesUpdatesValuesInStorage() {
