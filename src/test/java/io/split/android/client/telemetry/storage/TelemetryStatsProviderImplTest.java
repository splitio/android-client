...
public class TelemetryStatsProviderImplTest {
    ...
    @Mock
    private MySegmentsStorage mySegmentsStorage;
    private TelemetryStatsProvider telemetryStatsProvider;

    @Before
    public void setUp() {
        MockitoAnnotations.openMocks(this);
        telemetryStatsProvider = new TelemetryStatsProviderImpl(telemetryStorageConsumer, splitsStorage, mySegmentsStorage);
    }
