...
import io.split.sharedtest.helper.JsonAssert;
...
public class UniqueKeysIntegrationTest {
    ...
    public void verifyRequestBody() throws InterruptedException {
        ...
        assertTrue(await);
        JsonAssert.assertJsonEquals("{\"keys\":[{\"fs\":[\"android_test_2\",\"android_test_3\"],\"k\":\"key1\"},{\"fs\":[\"android_test_2\"],\"k\":\"key2\"}]}", mUniqueKeysBody.get());
    ...
    public void verifyKeyFeaturesAreMerged() throws InterruptedException {
        ...
        assertTrue(await);
        JsonAssert.assertJsonEquals("{\"keys\":[{\"fs\":[\"f2\",\"f3\",\"f4\",\"f1\"],\"k\":\"key1\"},{\"fs\":[\"f1\"],\"k\":\"key2\"}]}", mUniqueKeysBody.get());
    ...
    public void verifyDatabaseIsEmptyAfterRequest() throws InterruptedException {
        ...
        assertTrue(await);
        JsonAssert.assertJsonEquals("{\"keys\":[{\"fs\":[\"android_test_2\",\"android_test_3\"],\"k\":\"key1\"}]}", mUniqueKeysBody.get());
        Thread.sleep(500);
