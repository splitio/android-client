...
public class SplitCache implements ISplitCache {
    ...
    public boolean addSplit(String splitName, String split) {
        try {
            ...
            Timber.e(e,"Failed to add split %s", splitName);
        }
        return false;
    }
    ...
    public boolean setChangeNumber(long changeNumber) {
        try {
            ...
            Timber.e(e, "Failed to set changeNumber");
            return false;
        }
    }
    ...
    public long getChangeNumber() {
        try {
            ...
            Timber.e(e, "Failed to get changeNumber");
            return -1;
        }
    }
    ...
    public String getSplit(String splitName) {
        try {
            ...
            Timber.e(e, "Failed to get split %s", splitName);
        }
        return null;
    }
