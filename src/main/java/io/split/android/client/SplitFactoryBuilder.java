...
public class SplitFactoryBuilder {
     ...
     * @throws IOException                           if the SDK was being started in 'all.localhost' mode, but
     ...
     * @return a SplitFactory
     * @throws java.io.IOException                   if the SDK was being started in 'all.localhost' mode, but
     *                                               there were problems reading the override file from disk.
