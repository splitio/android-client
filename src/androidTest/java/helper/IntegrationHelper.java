...
public class IntegrationHelper {
    ...
    public static String splitChangeV2CompressionType2() {
        return splitChangeV2("1684265694505",
                "0",
                "2",
    ...
    private static String splitChangeV2(String changeNumber, String previousChangeNumber, String compressionType, String compressedPayload) {
        return "{\n" +
                "  \"id\":\"vQQ61wzBRO:0:0\",\n" +
                "  \"clientId\":\"pri:MTUxNzg3MDg1OQ==\",\n" +
                "  \"timestamp\":1684265694676,\n" +
                "  \"encoding\":\"json\",\n" +
                "  \"channel\":\"NzM2MDI5Mzc0_MjkyNTIzNjczMw==_splits\",\n" +
                "  \"data\":\"{\\\"type\\\":\\\"SPLIT_UPDATE\\\",\\\"changeNumber\\\":" + changeNumber + ",\\\"pcn\\\":" + previousChangeNumber + ",\\\"c\\\":" + compressionType + ",\\\"d\\\":\\\"" + compressedPayload + "\\\"}\"\n" +
                "}";
    }
